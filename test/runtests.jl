...
@testset "assignment11.jl" begin
    ...
    sol = assignment11.gas_solver(params...)
...
@testset "private" begin
    params = [2500.0, 1.0e6, 14.504, 518.67, 1900, 0.95, 2.0, 679.66, 0.056, 1.e2]
    sol = assignment11.gas_solver(params...)
    @test all(isapprox.(getindex.(sol.u, 1)[10:15], [2305.855, 2257.412, 2215.141, 2146.140, 2092.990, 2049.777], atol=1.0e-3))
end
